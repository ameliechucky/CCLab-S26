...
let dancerClasses = [LOL, Makabaka, YasmineDancer, RoboDancer, Brena, TrafficTwins, Ashley, JoellaDancer, Nono, RobotDancer, MonkeyDancer, Hubert, EvanDancer, BankharDancer, Shakira, HarpersDancer];
